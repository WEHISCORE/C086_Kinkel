...
<aside>
A PDF version of these figures are available in [`output/figures/paper/male.gene_set_tests.pdf`](../output/figures/paper/male.gene_set_tests.pdf).
</aside>

```{r, results = "hide"}
dir.create(here("output/figures/paper"))
pdf(
  here("output/figures/paper/male.gene_set_tests.pdf"),
  height = 6,
  width = 6)
par(mfrow = c(1, 1))
geneSetTestFiguresForPaper()
