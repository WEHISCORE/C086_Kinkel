...
Indeed, shown in [`output/figures/logCPM_pairs_plot.reads.pdf`](../output/figures/logCPM_pairs_plot.reads.pdf) are scatterplots of the log-CPM for pairs of technical replicates from each mouse which shows the replicates are highly correlated.
...
pdf(here("output", "figures", "logCPM_pairs_plot.reads.pdf"))
