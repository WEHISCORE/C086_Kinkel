...
```{r}
v_y <- voomWithQualityWeights(y, y_design, normalize.method = "quantile")
roast(
  v_y,
  index = y_index,
  design = y_design,
...
```{r}
v_ym <- voomWithQualityWeights(ym, ym_design, normalize.method = "quantile")
roast(
  v_ym,
  index = ym_index,
  design = ym_design,
...
```{r}
v_yf <- voomWithQualityWeights(yf, yf_design, normalize.method = "quantile")
roast(
  v_yf,
  index = yf_index,
  design = yf_design,
...
- [ ] Help interpreting flick in voom plot and plotSA plot
- [ ] Add Glimma
